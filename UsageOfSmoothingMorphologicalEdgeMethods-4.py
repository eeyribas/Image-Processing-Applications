...
plt.subplot(5,1,1),plt.imshow(img),
plt.title('Original Image')
plt.xticks([]), plt.yticks([])
plt.subplot(5,1,2),plt.imshow(dilation1),
plt.xticks([]), plt.yticks([])
plt.subplot(5,1,3),plt.imshow(sobel2),
plt.xticks([]), plt.yticks([])
plt.subplot(5,1,4),plt.imshow(dilation3),
plt.xticks([]), plt.yticks([])
plt.subplot(5,1,5),plt.imshow(dilation4),
plt.xticks([]), plt.yticks([])
